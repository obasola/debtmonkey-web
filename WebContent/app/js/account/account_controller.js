 ...
 **/
accountModule.controller('AccountCtrl', ['Account', 'AccountType', '$scope', '$routeParams', '$http', '$location', '$cookies', 'MessageHandler', 'restURL', function (Account, AccountType, $scope, $routeParams, $http, $location, $cookies, MessageHandler, restURL) {
        'AccountType', // edition mode
                $scope.mode = null;
